...
class Client(db.Model):
    ...
    # связь с парковками
    parkings = db.relationship('ClientParking', back_populates='client', cascade='all, delete-orphan')
...
class Parking(db.Model):
    ...
    # связь с клиентами
    clients = db.relationship('ClientParking', back_populates='parking', cascade='all, delete-orphan')
